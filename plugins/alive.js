...
const ALIVE_IMG = "https://files.catbox.moe/7pg24k.jpg"; // Assurez-vous que cette URL est valide
...
cmd({
    ...
    try {
        ...
        const formattedInfo = `
♻️ *RIKA MD V1 STATUS* ♻️
Hi 🫵🏽 ${pushname}
🕒 *Time*: ${currentTime}
📅 *Date*: ${currentDate}
⏳ *Uptime*: ${runtimeHours} hours, ${runtimeMinutes} minutes, ${runtimeSeconds} seconds

🤖 *Status*: *Rika is Alive and Ready!*
...
🎉 *Enjoy the Service!*
        ...
        await conn.sendMessage(from, {
            audio: { url: 'https://files.catbox.moe/m12hha.aac' },
            mimetype: 'audio/mp4',
            ptt: true,
            contextInfo: { 
                mentionedJid: [m.sender],
